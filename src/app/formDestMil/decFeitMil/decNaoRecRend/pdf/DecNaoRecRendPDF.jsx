    ...
    <Document>
      <Page style={styles.body} size={"A4"} orientation="portrait">
        ...
        <View style={styles.titleBox}>
          <Text style={styles.title1}>DECLARAÇÃO DE NÃO RECEBIMENTO DE RENDIMENTOS</Text>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Text style={styles.defaultText}>
            ...
            {data?.dependent?.nomeDep || "Não Informado"}, grau de parentesco:{" "}
            {data?.dependent?.grauParentDep || "Não Informado"}, Data de
            Nascimento: {data?.dependent?.datNascDep || "Não Informado"}; Idade:{" "}
            {data?.dependent?.idadeDep || "Não Informado"}; RG Nº{" "}
        ...
        <View style={styles.footerLaws}>
          <Text style={{ fontSize: 7 }}>
            ...
            prejuízo alheio, induzindo ou manter alguém em erro, mediante
            artifício, ardil ou qualquer outro meio fraudulento. (Estelionato).
          </Text>
          <Text style={{ fontSize: 7 }}>
            ...
            relevante. (Falsidade Ideológica).
          </Text>
        </View>
...
export default DecNaoRecRendPDF;
