...
const ReqRevalCartFunsPDF = ({ data }) => {
  return (
    <Document>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Text style={styles.defaultText}>
            ...
            <Text style={{ fontWeight: "700" }}>
              {data.postGradMilitar || "Não Informado"}
            </Text>
            ,{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.nomeMilitar || "Não Informado"}
            </Text>
            , Carteira Identidade nº:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.rgMilitar || "Não Informado"}
            </Text>
            , Matrícula nº{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.matriculaMilitar || "Não Informado"}
            </Text>
            , Nome de guerra:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.nomeGuerraMilitar || "Não Informado"}
            </Text>
            ; pertencente à unidade militar:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.unidMilitar || "Não Informado"}
            </Text>
            ; residente e domiciliado à:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.enderecoMilitar || "Não Informado"}
            </Text>
            ; nº{" "}
            <Text style={{ fontWeight: "700" }}>
            ...
            ; complemento:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.compEndMilitar || "Não Informado"}
            </Text>
            ; bairro:
            <Text style={{ fontWeight: "700" }}>
              {data.bairroEndMilitar || "Não Informado"}
            </Text>
            ; município:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.municipEndMilitar || "Não Informado"}
            </Text>
            ; Estado:
            <Text style={{ fontWeight: "700" }}>
              {data.estEndMilitar || "Não Informado"}
            </Text>
            ; CEP nº{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.cepMilitar || "Não Informado"}
            </Text>
            ; telefone fixo:
            <Text style={{ fontWeight: "700" }}>
              {data.telFixoMilitar || "Não Informado"}
            </Text>
            ; telefone móvel:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data.telMovelMilitar || "Não Informado"}
            </Text>
...
export default ReqRevalCartFunsPDF;
