        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Text style={styles.defaultText}>
            ...
            <Text style={{ fontWeight: "700" }}>
              {data?.nomeDep || "Não Informado"}
            </Text>
            , Carteira Identidade nº:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.rgDep || "Não Informado"}
            </Text>
            , CPF nº{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.cpfDep || "Não Informado"}
            </Text>
            ; residente e domiciliado à:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.endDep || "Não Informado"}
            </Text>
            ; nº{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.numEndDep || "Não Informado"}
            </Text>
            ; complemento:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.compEndDep || "Não Informado"}
            </Text>{" "}
            ; bairro:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.bairroDep || "Não Informado"}
            </Text>{" "}
            ; município:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.municDep || "Não Informado"}
            </Text>{" "}
            ; Estado:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.estDep || "Não Informado"}
            </Text>{" "}
            ; CEP nº{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.cepDep || "Não Informado"}
            </Text>{" "}
            ; telefone fixo:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.telFixDep || "Não Informado"}
            </Text>{" "}
            ; telefone móvel:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.telMovDep || "Não Informado"}
            </Text>{" "}
            na qualidade de dependente:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.qualDep || "Não Informado"}
            </Text>
            , do(a) militar estadual:
            <Text style={{ fontWeight: "700" }}>
              {data?.postMil || "Não Informado"},
            </Text>{" "}
            <Text style={{ fontWeight: "700" }}>
            ...
            , Matrícula nº{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.matMil || "Não Informado"}
            </Text>
            , Nome de guerra:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.nomGuerraMil || "Não Informado"}
            </Text>
            ; pertencente à unidade militar:{" "}
            <Text style={{ fontWeight: "700" }}>
              {data?.unidMil || "Não Informado"}
            </Text>
            ; Falecido: ( ) Não ( ) Sim, vem muito respeitosamente requerer à V.
            S.ª, que seja
            ...
            <Text style={{ fontWeight: "700" }}>
              {" "}
              {data?.queSejConMil || "Não Informado"}
            </Text>
          </Text>
        </View>
...
export default ReqDivIntDepPDF;
