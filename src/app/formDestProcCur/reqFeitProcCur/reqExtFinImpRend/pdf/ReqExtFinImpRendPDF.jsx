...
const ReqExtFinImpRendPDF = ({ data }) => {
  return (
    <Document>
      <Page style={styles.body} size={"A4"} orientation="portrait">
        ...
        <View style={styles.titleBox}>
          <Text style={styles.title1}>REQUERIMENTO DE EXTRATO PARA FINS DE IRPF</Text>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Text style={styles.defaultText}>
            ...
            ; vem muito respeitosamente requerer à V. S.ª, o EXTRATO INDIVIDUAL, ano:
            <Text style={{ fontWeight: "700" }}>
            {" "}{data?.anoMil ||"00/00/0000" }
            </Text>
            , para fins de IMPOSTO DE RENDA PESSOA FÍSICA - IRPF, referente ao militar estadual TITULAR ({" "}) e seus(s) DEPENDENTE(S) ({" "}).
          </Text>
        </View>
...
export default ReqExtFinImpRendPDF;
