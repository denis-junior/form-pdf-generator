      ...
      <Page style={styles.body} size={"A4"} orientation="portrait">
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Text style={styles.defaultText}>
            Eu, -NOME COMPLETO AQUI-, Carteira de Identidade nº -RG AQUI-, CPF
            nº: -CPF AQUI-, telefone -TELEFONE AQUI-, neste ato representando
            como: PROCURADOR(A) ( ) OU ( ) CURADOR(A), ( ) do(a) militar
            estadual, -POSTO GRADUACAO AQUI-, -NOME MILITAR AQUI-, Carteira
            Identidade nº: -RG MILITAR AQUI-, Matrícula nº -MATRICULA MILITAR
            AQUI-, Nome de guerra: -NOME DE GUERRA MILITAR AQUI-; pertencente à
            unidade militar: -UNID MILITAR DO MILITAR AQUI-; residente e
            domiciliado à: -ENDERECO MILITAR AQUI-; nº -NUMERO ENDERECO MILITAR
            AQUI-; complemento: -COMPLEMENTO ENDERECO MILITAR AQUI-; bairro:
            -BAIRRO MILITAR AQUI-; município: -MUNICIPIO MILITAR AQUI-; Estado:
            -ESTADO MILITAR AQUI-; CEP nº -CEP MILITAR AQUI-; telefone fixo
            -TELEFONE FIXO AQUI-; telefone móvel: -TELEFONE MOVEL MILITAR AQUI-;
        ...
        <View style={styles.bodyTable}>
          <Text style={{ padding: 5, fontSize: 10, width: "10%" }}>1</Text>
          <Text
            style={{
              borderLeft: 1,
              padding: 5,
          ...
          >
            Denis Charles Ferreira do Carmo Junior
          </Text>
          <Text
            style={{ borderLeft: 1, padding: 5, fontSize: 10, width: "50%" }}
          >
            Filho
          </Text>
          <Text
            style={{ borderLeft: 1, padding: 5, fontSize: 10, width: "30%" }}
          >
            21
          </Text>
          <Text
            style={{ borderLeft: 1, padding: 5, fontSize: 10, width: "20%" }}
          >
            Não
          </Text>
        </View>
